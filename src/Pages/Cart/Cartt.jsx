...
function Cartt() {
  ...
  const imageUrl = product ? storage.getFilePreview(conf.appwriteBucketId_2, product.imagekey) : '';
            ...
            <ul className="space-y-4">
              {cartItems.map((cartItem, index) => (
                <li key={index} className="flex items-center gap-4">
                  <img
                    src={storage.getFilePreview(conf.appwriteBucketId_2, cartItem.product.imagekey)}
                    alt=""
