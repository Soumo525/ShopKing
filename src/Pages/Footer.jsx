  ...
  <div className="container relative z-10 mx-auto px-4">
    <div className="-m-8 flex flex-wrap items-center justify-between">
      ...
      <Link to= "/">
          ...
          <BsShop size={30} /> {/* Set the size of the icon here */}
            <span className="ml-4 text-lg font-bold">ShopKing</span>
      ...
      <p> @2024 <a href='https://github.com/Soumo525'>Soumo Dhali</a></p>
      <p>All Logos & Trademarks On The Site Are Property Of Their Respective Owners.</p>
