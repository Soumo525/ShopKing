...
<button
      onClick={onClick}
      className="inline-flex items-center justify-center p-0.5 mb-2 me-1  
      ...
      dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 
      dark:focus:ring-cyan-800"
    >
      <span className="px-5 py-2.5 transition-all ease-in duration-75 
