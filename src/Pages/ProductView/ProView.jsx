...
function ProView() {
  ...
  const imageUrl = storage.getFilePreview(conf.appwriteBucketId_1, product.imagekey);
  //console.log(firstBucketId, product.imagekey);
  ...
  return (
    <>
      ...
      {/* WhatsApp widget */}
      {/* <WhatsAppWidget phoneNumber="whatsappphonenumber" /> */}
    </>
  );
}
